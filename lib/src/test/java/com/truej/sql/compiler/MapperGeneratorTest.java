...
import com.truej.sql.v3.compiler.StatementGenerator;
...
public class MapperGeneratorTest {
    ...
    @Test void single() {
        ...
        MapperGenerator.generate(out, "Bill", List.of(
            new Field(new ScalarType(false, "java.lang.Long"), "id"),
            new Field(new ScalarType(false, "java.lang.String"), "currency"),
            new Field(new ScalarType(false, "java.math.BigDecimal"), "amount")
        ), (t, i) -> switch (t) {
    ...
    class LongRW implements ParameterSetter<Long> {
        @Override public void set(PreparedStatement stmt, int i, Long v) throws SQLException {
            stmt.setLong(i, v);
        }
    }
    ...
    @Test void t1() {
        ...
        //ParameterSetter<Long> x = new LongRW();
        var xx = x;
    }
    ...
    @Test void grouped() {
        ...
        MapperGenerator.generate(out, "Clinic", List.of(
            new Field(new ScalarType(false, "java.lang.Long"), "id"),
            new Field(new ScalarType(false, "java.lang.String"), "name"),
            new Field(
                new AggregatedType(null, List.of(
                    new Field(new ScalarType(false, "java.lang.String"), null)
                )),
                "addresses"
            ),
            new Field(
                ...
                new AggregatedType("Patient", List.of(
                    ...
                    new Field(
                        new AggregatedType("Bill", List.of(
                            new Field(new ScalarType(false, "java.lang.Long"), "id"),
                            new Field(new ScalarType(false, "java.lang.String"), "currency"),
                            new Field(new ScalarType(false, "java.math.BigDecimal"), "money")
                        )),
                        "bills"
                    )
                )),
